        ...
        <div className="flex-1 flex flex-col items-center w-full">
            <div className="w-full max-w-6xl mx-auto flex flex-col gap-6">
                ...
                <div className="flex items-center gap-2 text-sm">
                    ...
                    <span className="text-gray-400">/</span>
                    <span className="text-[#0d1b12] dark:text-white font-medium">Os Boleiros de Terça</span>
                </div>
                        ...
                        <div className="flex flex-col md:flex-row gap-6 md:items-center">
                            ...
                            <div className="flex flex-col gap-1">
                                <div className="flex items-center gap-3 flex-wrap">
                                    <h1 className="text-2xl md:text-3xl font-bold text-[#0d1b12] dark:text-white tracking-tight">Os Boleiros de Terça</h1>
                                ...
                                <p className="text-gray-500 dark:text-gray-400 text-base md:text-lg">Futebol de terça-feira à noite na Arena Power.</p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 flex flex-col gap-6">
                    ...
                    {/* Match Card 1 (Active/Soon) */}
                    <div className="bg-white dark:bg-[#183020] rounded-xl p-5 border border-[#13ec5b]/30 shadow-[0_4px_20px_-4px_rgba(19,236,91,0.15)] transition-transform hover:-translate-y-1 duration-300">
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div className="flex flex-col">
                                    <div className="flex items-center gap-2 mb-1">
                                        <h3 className="font-bold text-lg text-[#0d1b12] dark:text-white">Pelada Semanal #142</h3>
                                    ...
                                    <div className="flex flex-col gap-1 text-sm text-gray-500 dark:text-gray-400">
                                        <div className="flex items-center gap-1.5">
                                            ...
                                            <span>19:30 - 21:00 (1h30)</span>
                                        </div>
                                        <div className="flex items-center gap-1.5">
                                            <span className="material-symbols-outlined text-[18px]">location_on</span>
                                            <span>Arena Society, Quadra 2</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div className="flex items-center sm:self-center gap-3 mt-2 sm:mt-0">
                                {/* Avatars of confirmed players small */}
                                <div className="flex -space-x-2 mr-2 hidden md:flex">
                                    ...
                                    <div className="w-8 h-8 rounded-full border-2 border-white dark:border-[#1f3b29] bg-gray-100 flex items-center justify-center text-[10px] font-bold text-gray-600">+11</div>
                                </div>
                                <Link href="/dashboard/partidas/142" className="w-full sm:w-auto bg-[#13ec5b] hover:bg-[#0fd650] text-[#0d1b12] font-bold py-2.5 px-6 rounded-full transition-colors shadow-sm shadow-[#13ec5b]/30 flex items-center justify-center gap-2">
                    ...
                    {/* Match Card 2 (Future/Needs Players) */}
                    <div className="bg-white dark:bg-[#183020] rounded-xl p-5 border border-[#e7f3eb] dark:border-[#1f3b29] transition-transform hover:-translate-y-1 duration-300">
                        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                            <div className="flex items-start gap-4">
                                {/* Date Badge */}
                                <div className="flex flex-col items-center justify-center w-16 h-16 bg-gray-100 dark:bg-gray-800 text-gray-500 dark:text-gray-400 rounded-2xl shrink-0">
                                    <span className="text-xs font-bold uppercase tracking-wider">Nov</span>
                                    <span className="text-2xl font-black leading-none">19</span>
                                </div>
                                <div className="flex flex-col">
                                    <div className="flex items-center gap-2 mb-1">
                                        <h3 className="font-bold text-lg text-[#0d1b12] dark:text-white">Pelada Semanal #143</h3>
                                        <span className="px-2 py-0.5 rounded-full bg-yellow-100 dark:bg-yellow-900/30 text-yellow-700 dark:text-yellow-400 text-[10px] font-bold uppercase border border-yellow-200 dark:border-yellow-800">Faltam 4</span>
                                    </div>
                                    <div className="flex flex-col gap-1 text-sm text-gray-500 dark:text-gray-400">
                                        <div className="flex items-center gap-1.5">
                                            <span className="material-symbols-outlined text-[18px]">schedule</span>
                            ...
                            <div className="flex items-center sm:self-center gap-3 mt-2 sm:mt-0">
                                <button className="w-full sm:w-auto bg-white dark:bg-[#183020] border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800 text-[#0d1b12] dark:text-white font-semibold py-2.5 px-6 rounded-full transition-colors flex items-center justify-center gap-2">
                                    <span>Ver partida</span>
                                </button>
                            </div>
                        </div>
